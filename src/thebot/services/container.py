...
class DependencyContainer:
    ...
    def _register_default_dependencies(self):
        ...
        # Note: Adapté pour src/thebot/ - dépendances simplifiées
...
def register_dependency(name: str, instance: Any = None, factory: Optional[Callable] = None, lazy_singleton: Optional[Type] = None) -> None:
    """
