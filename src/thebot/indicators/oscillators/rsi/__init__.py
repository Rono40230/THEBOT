...
class RSIIndicator(BaseIndicator):
    ...
    def generate_signal(self, current_result: IndicatorResult) -> Optional[Signal]:
        ...
        if signal_direction:
            ...
            if current_rsi <= self.config.extreme_oversold or current_rsi >= self.config.extreme_overbought:
                confidence = 0.9
            elif current_rsi <= self.config.oversold_level or current_rsi >= self.config.overbought_level:
                confidence = 0.7
            else:
            ...
            signal = Signal(
                ...
                price=current_result.metadata.get('price', Decimal('0')),  # Prix depuis metadata si dispo
    ...
    def get_signal_quality(self) -> dict:
        ...
        return {
            ...
            'extreme_ratio': extreme_signals / total_signals if total_signals > 0 else 0,
