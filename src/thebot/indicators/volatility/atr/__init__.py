...
class ATRIndicator(BaseIndicator):
    ...
    def generate_signal(self, current_result: IndicatorResult) -> Optional[Signal]:
        ...
        if signal_direction:
            ...
            confidence = min(0.8, 0.5 + abs(normalized_atr - Decimal('1.0')) / Decimal('2.0'))
    ...
    def get_breakout_threshold(self, multiplier: Decimal = Decimal('1.5')) -> Optional[Decimal]:
        """
    ...
    def get_stop_loss_distance(self, multiplier: Decimal = Decimal('2.0')) -> Optional[Decimal]:
        """
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        if self.current_value and self._price_history:
            ...
            base_metadata.update({
                ...
                'volatility_percentile': float(self.calculator.get_volatility_percentile() or 0)
            })
