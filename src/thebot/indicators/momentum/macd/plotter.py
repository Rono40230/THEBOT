...
class MACDPlotter:
    ...
    def _add_histogram(self, fig: go.Figure, histogram: pd.Series):
        ...
        colors = [
            (
                self.config.histogram_positive_color
                if x >= 0
    ...
    def _add_macd_lines(self, fig: go.Figure, macd_data: Dict[str, pd.Series]):
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="lines",
                name="MACD",
                line=dict(color=self.config.macd_color, width=self.config.line_width),
                showlegend=True,
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="lines",
                name="Signal",
                line=dict(color=self.config.signal_color, width=self.config.line_width),
                showlegend=True,
    ...
    def _add_crossover_signals(
        self, fig: go.Figure, macd_data: Dict[str, pd.Series], signals: pd.DataFrame
    ):
    ...
    def get_visual_config(self) -> Dict[str, any]:
        ...
        return {
            ...
            "histogram_positive_color": getattr(
                self.config, "histogram_positive_color", "#4CAF50"
            ),
            "histogram_negative_color": getattr(
                self.config, "histogram_negative_color", "#F44336"
            ),
