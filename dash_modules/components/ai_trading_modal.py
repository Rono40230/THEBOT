...
class AITradingModal:
            ...
            [
                dbc.ModalHeader(
                    [
                                ...
                                html.H4(
                                    [
                                        ...
                                        html.Small(
                                            [
                                                html.I(
                                                    className="fas fa-arrows-alt ms-3 text-muted"
                                                ),
                                                " Déplaçable",
                                            ],
                                        ...
                                        dbc.Col(
                                            [
                                                ...
                                                dcc.Dropdown(
                                                    ...
                                                    options=[
                                                        {
                                                            "label": "🆓 IA Locale (Gratuit)",
                                                            "value": "local",
                                                        },
                                                        {
                                                            "label": "🎯 IA Smart (HuggingFace)",
                                                            "value": "smart",
                                                        },
                                                        {
                                                            "label": "⚡ IA Hybride",
                        ...
                        dbc.Button(
                            "×", id="ai-modal-close", className="btn-close", n_clicks=0
                        ),
                    ],
                    ...
                    [
                        ...
                        dbc.Spinner(
                            [
                                html.Div(
                                    id="ai-modal-content",
                                    children=[self._create_placeholder_content()],
                                )
                            ],
                            id="ai-modal-spinner",
            ...
            [
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            [
                                self._create_technical_analysis_card(
                        ...
                        dbc.Col(
                            [
                                self._create_sentiment_analysis_card(
                ...
                self._create_recommendation_card(
                    analysis_data.get("trading_recommendation", {})
                ),
                # Détails et contexte
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                self._create_risk_assessment_card(
                        ...
                        dbc.Col(
                            [
                                self._create_market_context_card(
    ...
    def _create_analysis_header(self, symbol: str, data: Dict) -> html.Div:
        ...
        recommendation = data.get("trading_recommendation", {}).get(
            "recommendation", "HOLD"
        )
                            ...
                            [
                                dbc.Col(
                                    [
                                        ...
                                        html.P(
                                            "Analyse complète technique et sentiment",
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Score Technique", className="form-label small"
                                ),
                                dbc.Progress(
                                    value=score, color=progress_color, className="mb-2"
                                ),
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Patterns Détectés", className="form-label small"
                                ),
                                html.Div(
                                    [
                                        dbc.Badge(
                                            pattern, color="info", className="me-1 mb-1"
                                        )
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Sentiment Marché", className="form-label small"
                                ),
                                html.Div(
                                    [
                                        dbc.Badge(
                                            [
                                                html.I(
                                                    className=f"{sentiment_icon} me-1"
                                                ),
                                                sentiment.title(),
                                            ],
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Score Sentiment", className="form-label small"
                                ),
                                dbc.Progress(
                                    value=score, color=sentiment_color, className="mb-2"
                                ),
                                html.Small(f"{score}/100", className="text-muted"),
                            ],
                            className="mb-3",
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Sources Analysées", className="form-label small"
                                ),
                                html.Div(
                                    [
                        ...
                        dbc.Row(
                            [
                                ...
                                dbc.Col(
                                    [
                                        html.Label(
                                            "Explication", className="form-label small"
                                        ),
                ...
                dbc.CardBody(
                    [
                        html.Div(
                            [
                                html.Label(
                                    "Niveau de Risque", className="form-label small"
                                ),
                                dbc.Badge(
                                    risk_level, color="warning", className="fs-6"
                                ),
                            ],
                            className="mb-3",
                        ),
                        html.Div(
                            [
                                html.Label(
                                    "Facteurs de Risque", className="form-label small"
                                ),
                                html.Ul(
                                    [
                                        html.Li(factor, className="small")
        ...
        return dbc.Card(
            [
                dbc.CardHeader(
                    [
                        html.H6(
                            [html.I(className="fas fa-globe me-2"), "Contexte Marché"],
                            className="mb-0",
                        )
                    ]
                ),
                dbc.CardBody(
                    [
                        html.Div(
                            [
                                html.Label(
                                    "Humeur du Marché", className="form-label small"
                                ),
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Corrélations", className="form-label small"
                                ),
                                html.Div(
                                    [
...
def generate_ai_analysis(
    ...
    try:
        ...
        technical_data = {
            "price_data": {},
            "indicators": {"rsi": 65.5, "macd": 0.15, "bb_position": 0.7},
        }
        ...
        if ai_engine == "smart" and smart_ai_manager:
            ...
            technical_analysis = local_ai_engine.analyze_technical_pattern(
                technical_data["price_data"], technical_data["indicators"]
            )
        else:
            # Fallback
            technical_analysis = {
        ...
        if smart_ai_manager and news_data and ai_engine in ["smart", "hybrid"]:
            ...
            for article in news_data[:10]:
                if isinstance(article, dict):
                    ...
                    summary = article.get("summary", "") or article.get(
                        "description", ""
                    )
        ...
        trading_recommendation = (
            local_ai_engine.generate_trading_insight(
        ...
        if trading_recommendation["confidence"] < confidence_threshold:
            ...
            trading_recommendation[
                "explanation"
            ] += f" (Confiance {trading_recommendation['confidence']}% < seuil {confidence_threshold}%)"
