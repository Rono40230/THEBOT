...
class SymbolSearchComponent:
    ...
    def render_search_input(
        self, placeholder: str = "Tapez BTC, ETH, ADA..."
    ) -> dbc.InputGroup:
        ...
        return dbc.InputGroup(
            [
                ...
                dbc.Button(
                    ...
                    color="primary",
                    size="sm",
                    style={"border": "2px solid #0d6efd", "borderLeft": "none"},
                ),
            ],
            style={"border": "none"},
        )
    ...
    def create_result_buttons(
        self, symbols: List[str], max_display: int = 12
    ) -> List[dbc.Button]:
        ...
        for symbol in symbols[:max_display]:
            ...
            buttons.append(
                dbc.Button(
                    [html.I(className=f"me-1 {icon}"), symbol],
    ...
    def get_complete_layout(
        self,
        label: str = "Rechercher un Actif",
        placeholder: str = "Tapez BTC, ETH, ADA...",
    ) -> dbc.Col:
