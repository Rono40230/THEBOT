...
class WidgetManager:
    ...
    def save_layout(self, layout_name: str, widgets_config: Dict, user_id: str = "default") -> bool:
    ...
    def load_layout(self, layout_name: str, user_id: str = "default") -> Optional[Dict]:
        ...
        try:
            ...
            logger.warning(f"⚠️ Layout non trouvé: {layout_name}, utilisation par défaut")
    ...
    def get_widget_settings(self, widget_id: str, layout_name: str = "default", user_id: str = "default") -> Dict:
    ...
    def update_widget_settings(self, widget_id: str, new_settings: Dict, layout_name: str = "default", user_id: str = "default") -> bool:
        ...
        for widget_id, config in widgets_config.items():
            ...
            if isinstance(config, dict):
                validated_widget = {
                    ...
                    'position': config.get('position', {'x': 0, 'y': 0, 'w': 6, 'h': 4}),
    ...
    def export_layout(self, layout_name: str, user_id: str = "default") -> Optional[str]:
    ...
    def import_layout(self, layout_json: str, new_name: str, user_id: str = "default") -> bool:
