                ...
                dbc.Col(
                    [
                        ...
                        dbc.ButtonGroup(
                            [
                                dbc.Button(
                                    "BUY", color="success", size="sm", outline=True
                                ),
                                dbc.Button(
                                    "SELL", color="danger", size="sm", outline=True
                                ),
                                dbc.Button(
                                    "HOLD", color="warning", size="sm", outline=True
                                ),
                            ]
                        ),
                    ],
    ...
    def create_indicators_sidebar(self) -> html.Div:
        ...
        return html.Div(
            [
                # Titre de la section
                html.H5(
                    [html.I(className="fas fa-chart-bar me-2"), "Technical Indicators"],
            ...
            [
                ...
                dbc.Card(
                    [
                        ...
                        dbc.CardBody([html.Div(id="technical-summary")]),
                    ],
                    className="mb-3",
                ),
                # Performance Metrics
                        ...
                        dbc.CardBody(
                            [
                                html.Div(
                                    [
                                        html.Small(
                                            "Last Update: ", className="text-muted"
                                        ),
                                        html.Span(
                                            id="last-update", className="fw-bold"
                                        ),
                                    ],
                                    className="mb-2",
                                ),
                                html.Div(
                                    [
                                        html.Small(
                                            "Data Points: ", className="text-muted"
                                        ),
                                        html.Span(
                                            id="data-points",
