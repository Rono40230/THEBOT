...
from .modals.modal_manager import modal_manager
from .modals.modal_manager import MODAL_CSS
...
class ModalAdapter:
    ...
    def _convert_new_to_old_format(self, basic_config: Dict, advanced_config: Dict) -> Dict[str, Any]:
    ...
    def export_debug_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'new_system_config': self.new_modal.parameters.config if self.use_new_system else None,
            'old_system_config': self.old_modal.indicators_config if not self.use_new_system else None,
