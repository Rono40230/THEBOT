...
class AdvancedIndicatorsTab:
    ...
    def create_content(self) -> html.Div:
        ...
        sr_section = self._create_support_resistance_section(config.get("support_resistance", {}))
        ...
        pivot_section = self._create_pivot_points_section(config.get("pivot_points", {}))
    ...
    def _create_fibonacci_section(self, fib_config: Dict) -> html.Div:
        ...
        controls = [
            ...
            dbc.Row([
                dbc.Col([
                    html.H6("Niveaux Fibonacci", className="text-light mt-3 mb-2"),
                    html.Div([
                        dbc.Badge("0.0%", color="secondary", className="me-1"),
                        dbc.Badge("23.6%", color="info", className="me-1"),
                        dbc.Badge("38.2%", color="primary", className="me-1"),
                        dbc.Badge("50.0%", color="warning", className="me-1"),
                        dbc.Badge("61.8%", color="success", className="me-1"),
                        dbc.Badge("78.6%", color="danger", className="me-1"),
            ...
            dbc.Row([
                dbc.Col([
                    self.controls_factory.create_dropdown_control(
                        ...
                        "Méthode de calcul",
                        [
                            {"label": "Standard (Classic)", "value": "traditional"},
                ...
                dbc.Col([
                    ...
                    dbc.Checklist(
                        ...
                        value=[
                            level for level, show in pivot_config.items() 
    ...
    def _create_quick_actions(self) -> dbc.Card:
        ...
        return dbc.Card([
            dbc.CardHeader([
                html.H6("⚡ Actions Rapides Avancées", className="mb-0 text-primary")
            ]),
            dbc.CardBody([
                dbc.Row([
                    dbc.Col([
                        dbc.Button(
                            [html.I(className="fas fa-chart-line me-2"), "S/R + Fibonacci"],
                    ...
                    dbc.Col([
                        dbc.Button(
                            [html.I(className="fas fa-crosshairs me-2"), "Pivots + S/R"],
                    ...
                    dbc.Col([
                        dbc.Button(
                            [html.I(className="fas fa-toggle-off me-2"), "Tout Désactiver"],
                    ...
                    dbc.Col([
                        dbc.Button(
                            [html.I(className="fas fa-undo me-2"), "Valeurs Défaut"],
    ...
    def _register_callbacks(self):
        ...
        def update_advanced_previews(sr_strength, sr_lookback, fib_swing, fib_width, 
                                   pivot_method, pivot_levels):
            """Mettre à jour les previews des indicateurs avancés"""
            
            # S/R Preview
            sr_preview = html.Div([
                dbc.Badge(f"Force: {sr_strength or 2}", color="info", className="me-2"),
                dbc.Badge(f"Lookback: {sr_lookback or 50}", color="secondary", className="me-1")
            ])
            
            # Fibonacci Preview
            fib_preview = html.Div([
                dbc.Badge(f"Swing: {fib_swing or 20}", color="primary", className="me-2"),
                dbc.Badge(f"Ligne: {fib_width or 1}px", color="success", className="me-1"),
            ...
            pivot_preview = html.Div([
                dbc.Badge(f"Méthode: {method_labels.get(pivot_method or 'traditional', 'Standard')}", 
                         color="primary", className="me-2"),
                dbc.Badge(f"{len(pivot_levels or [])} niveaux", color="info", className="me-1")
            ])
        ...
        def update_advanced_status(sr_enabled, fib_enabled, pivot_enabled):
            ...
            enabled_count = sum([
                sr_enabled or False,
                fib_enabled or False,
                pivot_enabled or False
            ])
            ...
            if enabled_count == 0:
                ...
                color = "warning"
                text = f"Indicateurs avancés partiels ({enabled_count}/{total_indicators})"
