...
class CryptoChartComponents:
    ...
    def __init__(self):
        ...
        self.secondary_chart_config = {"displayModeBar": False, "responsive": True}
    ...
    def create_rsi_chart(
        self, data: pd.DataFrame, rsi_data: pd.Series, symbol: str
    ) -> go.Figure:
        ...
        if not rsi_data.empty:
            ...
            fig.add_hline(
                y=70, line=dict(color="red", dash="dash"), annotation_text="Surachat"
            )
            fig.add_hline(
                y=30, line=dict(color="green", dash="dash"), annotation_text="Survente"
            )
            fig.add_hline(
                y=50,
                line=dict(color="gray", dash="dot"),
                annotation_text="Ligne médiane",
            )
    ...
    def create_atr_chart(
        self, data: pd.DataFrame, atr_data: Dict, symbol: str
    ) -> go.Figure:
    ...
    def create_macd_chart(
        self, data: pd.DataFrame, macd_data: Dict, symbol: str
    ) -> go.Figure:
    ...
    def add_structural_levels_to_chart(
        self, fig: go.Figure, structural_data: Dict
    ) -> go.Figure:
        ...
        try:
            ...
            logger.warning(f"Erreur ajout niveaux structurels: {e}")

        return fig

    def create_empty_chart(
        self, message: str = "Aucune donnée disponible"
    ) -> go.Figure:
