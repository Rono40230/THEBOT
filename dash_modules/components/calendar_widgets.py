...
from ..data_providers.economic_events_config import (
    EventCategory,
    EventImpact,
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            [
                                html.H6(
                                    "Filtres par Pays", className="text-muted mb-2"
                                ),
                                dcc.Dropdown(
                                    id="country-filter",
                                    options=[
                        ...
                        html.Div(
                            [
                                html.H6(
                                    "Filtres par Catégorie", className="text-muted mb-2"
                                ),
                                dcc.Dropdown(
                                    id="category-filter",
                                    options=[
                        ...
                        html.Div(
                            [
                                html.H6(
                                    "Sélection Détaillée", className="text-muted mb-2"
                                ),
                            ...
                            [
                                ...
                                html.Span(
                                    [
                                        ...
                                        html.Small(
                                            event.description, className="text-muted"
                                        ),
                                    ]
                                ),
                            ],
                ...
                if event_items:
                    country_events.append(
                        html.Div(
                            [
                                html.H6(
                                    [impact_icon, f" Impact {impact_level.title()}"],
...
class CalendarWidget:
                            ...
                            [
                                dbc.ButtonGroup(
                                    [
                                        ...
                                        dbc.Button(
                                            "📋 Liste", id="view-list", size="sm"
                                        ),
                                        dbc.Button(
                                            "📊 Analyse", id="view-analysis", size="sm"
                                        ),
                                    ],
                                    className="w-100",
                                )
    ...
    def create_month_grid(self, calendar_data: Dict) -> html.Div:
        ...
        header_row = dbc.Row(
            [
                dbc.Col(
                    html.Div(day, className="text-center fw-bold text-muted"),
                    width=True,
                )
                for day in weekdays
            ],
        ...
        return html.Div([header_row, *calendar_rows], className="calendar-grid")
    ...
    def _create_calendar_day_cell(self, day: int, events: List[Dict]) -> html.Div:
        ...
        return html.Div(
            ...
            className=day_class,
            id={"type": "calendar-day", "index": day},
        )
    ...
    def create_events_table(self, events: List[Dict]) -> dash_table.DataTable:
        ...
        return dash_table.DataTable(
            ...
            style_data_conditional=[
                ...
                {"if": {"filter_query": "{status} = upcoming"}, "fontWeight": "bold"},
            ],
            style_header={
            ...
            if not impact_events.empty:
                fig.add_trace(
                    go.Scatter(
                        ...
                        mode="markers",
                        marker=dict(
                            size=12, color=impact_colors[impact], symbol="circle"
                        ),
...
class AnalyticsWidget:
    ...
    def create_impact_analysis(self, events: List[Dict]) -> html.Div:
        ...
        return dbc.Row(
            [
                dbc.Col([dcc.Graph(figure=impact_pie)], width=6),
                dbc.Col([dcc.Graph(figure=country_bar)], width=6),
            ]
        )

    def create_statistics_cards(
        self, events: List[Dict], calendar_data: Dict = None
    ) -> html.Div:
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H4(
                                            str(total_events), className="text-primary"
                                        ),
