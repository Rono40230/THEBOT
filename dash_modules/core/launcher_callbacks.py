...
class LauncherCallbacks:
    ...
    def __init__(self, app, modules: Dict[str, Any], layout_manager, data_manager) -> None:
        """
    ...
    def register_all_callbacks(self) -> None:
        ...
        try:
            ...
            self.logger.info("✅ Callbacks launcher enregistrés (callbacks problématiques supprimés)")
        ...
        def handle_tab_switch(active_tab: str):
            ...
            try:
                ...
                if active_tab == 'economic_news':
                    ...
                    return self.layout_manager._generate_module_placeholder('economic_news')
                    ...
                    if 'crypto_news' in self.modules:
                        ...
                        if hasattr(module, 'get_layout'):
                            return module.get_layout()
                    return self.layout_manager._generate_module_placeholder('crypto_news')
                    ...
                    if 'strategies' in self.modules:
                        ...
                        if hasattr(module, 'get_layout'):
                            return module.get_layout()
                    return self.layout_manager._generate_module_placeholder('strategies')
                
                else:
                    print(f"⚠️ Onglet inconnu: {active_tab}")
                    return html.Div([
                        html.H4(f"📊 Module: {active_tab}", className="text-center"),
                        html.P("Module en cours de développement", className="text-center text-muted")
                    ], className="p-4")
