    ...
    def __post_init__(self):
        ...
        if self.supported_markets is None:
            self.supported_markets = {
                ...
                'AAPL': {'label': '🍎 AAPL - Apple Inc.', 'type': 'stock', 'exchange': 'NASDAQ'},
                'GOOGL': {'label': '🔍 GOOGL - Alphabet Inc.', 'type': 'stock', 'exchange': 'NASDAQ'}, 
                'MSFT': {'label': '🖥️ MSFT - Microsoft Corp.', 'type': 'stock', 'exchange': 'NASDAQ'},
                'TSLA': {'label': '🚗 TSLA - Tesla Inc.', 'type': 'stock', 'exchange': 'NASDAQ'},
                'NVDA': {'label': '💻 NVDA - NVIDIA Corp.', 'type': 'stock', 'exchange': 'NASDAQ'},
                
                # Crypto (données réelles via API)
                'BTC-USD': {'label': '₿ Bitcoin', 'type': 'crypto', 'exchange': 'CRYPTO'},
                'ETH-USD': {'label': '⟠ Ethereum', 'type': 'crypto', 'exchange': 'CRYPTO'},
