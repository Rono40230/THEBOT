...
class FreeAIEngine:
    ...
    def analyze_with_huggingface(self, text: str, task: str = "sentiment-analysis", api_key: str = None) -> Dict:
            ...
            if response.status_code == 200:
                ...
                if isinstance(result, list) and len(result) > 0:
                    ...
                    return {
                        ...
                        'score': round(50 + (score * 50) if sentiment == 'bullish' else 50 - (score * 50), 1),
    ...
    def comprehensive_analysis(self, symbol: str, market_data: Dict, news_data: List[Dict]) -> Dict:
