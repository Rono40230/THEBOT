...
class RealDataManager:
    ...
    def __init__(self):
        ...
        self.supported_markets = {
            ...
            'AAPL_TD': {'label': 'Apple Inc. (Twelve Data)', 'type': 'stocks', 'provider': 'twelve_data'},
            'MSFT_TD': {'label': 'Microsoft Corp. (Twelve Data)', 'type': 'stocks', 'provider': 'twelve_data'},
            'GOOGL_TD': {'label': 'Alphabet Inc. (Twelve Data)', 'type': 'stocks', 'provider': 'twelve_data'},
            'TSLA_TD': {'label': 'Tesla Inc. (Twelve Data)', 'type': 'stocks', 'provider': 'twelve_data'},
            'EURUSD_TD': {'label': 'EUR/USD (Twelve Data)', 'type': 'forex', 'provider': 'twelve_data'},
            'GBPUSD_TD': {'label': 'GBP/USD (Twelve Data)', 'type': 'forex', 'provider': 'twelve_data'},
            'BTCUSD_TD': {'label': 'Bitcoin/USD (Twelve Data)', 'type': 'crypto', 'provider': 'twelve_data'},
        }
            ...
            if 'twelve_data' in sources:
                try:
                    if twelve_data_api.api_key:
                        twelve_data_news = twelve_data_api.get_financial_news(limit=limit//4)
                        all_news.extend(twelve_data_news)
                        logger.info(f"✅ Récupéré {len(twelve_data_news)} news de Twelve Data")
                    else:
