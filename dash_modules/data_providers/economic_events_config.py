    ...
    def _init_events(self) -> List[EconomicEvent]:
        ...
        events.extend(
            [
                ...
                EconomicEvent(
                    ...
                    frequency=EventFrequency.MONTHLY,
                    source="Bureau of Labor Statistics",
                    time_of_release="15:00",
                    unit="postes",
                ),
                EconomicEvent(
                    id="us_average_hourly_earnings",
        ...
        events.extend(
            [
                EconomicEvent(
                    ...
                    impact=EventImpact.CRITICAL,
                    frequency=EventFrequency.IRREGULAR,
        ...
        events.extend(
            [
                ...
                EconomicEvent(
                    ...
                    frequency=EventFrequency.MONTHLY,
                    source="Federal Reserve",
                    time_of_release="14:15",
                    unit="% MoM",
                ),
                EconomicEvent(
                    id="us_ism_manufacturing",
        ...
        events.extend(
            [
                EconomicEvent(
                    ...
                    country="US",
                    category=EventCategory.CONSUMPTION,
                    impact=EventImpact.HIGH,
                    frequency=EventFrequency.MONTHLY,
        ...
        events.extend(
            [
                EconomicEvent(
                    ...
                    time_of_release="12:45",
                    unit="%",
                ),
                EconomicEvent(
                    id="ecb_press_conference",
        ...
        events.extend(
            [
                EconomicEvent(
                    ...
                    country="US",
                    category=EventCategory.COMMODITIES,
                    impact=EventImpact.MEDIUM,
                    frequency=EventFrequency.WEEKLY,
                    source="Energy Information Administration",
                    time_of_release="15:30",
                    unit="barils",
                ),
                EconomicEvent(
                    id="api_crude_oil",
        ...
        events.extend(
            [
                EconomicEvent(
                    id="sec_crypto",
                    name="SEC Crypto Announcements",
                    description="Annonces SEC sur les cryptomonnaies",
                    country="US",
                    category=EventCategory.CRYPTO_REGULATORY,
                    impact=EventImpact.HIGH,
                    frequency=EventFrequency.IRREGULAR,
