...
class ForexModule(BaseMarketModule):
    ...
    def _analyze_daily_range(self, data: pd.DataFrame) -> Dict:
        ...
        return {
            ...
            "range_efficiency": (
                round((current_range / avg_range * 100), 1) if avg_range > 0 else 0
            ),
        }
                                    ...
                                    children=[
                                        ...
                                        html.P(
                                            [
                                                html.Strong("Coût: "),
                                                html.Span(
                                                    "0€/mois - Analyses forex illimitées",
    ...
    def _get_correlation_info(self, symbol: str) -> Dict:
        ...
        correlations = {
            "EURUSD": {
                "positive": ["GBPUSD", "AUDUSD"],
                "negative": ["USDCHF", "USDJPY"],
            },
            "GBPUSD": {
                "positive": ["EURUSD", "AUDUSD"],
                "negative": ["USDCHF", "USDJPY"],
            },
            "USDJPY": {
                "positive": ["USDCHF"],
                "negative": ["EURUSD", "GBPUSD", "AUDUSD"],
            },
            "USDCHF": {
                "positive": ["USDJPY"],
                "negative": ["EURUSD", "GBPUSD", "AUDUSD"],
        ...
        factors = {
            "EURUSD": {
                ...
                "key_factors": [
                    "ECB Policy",
                    "Fed Policy",
                    "EU-US Interest Rate Differential",
                ],
