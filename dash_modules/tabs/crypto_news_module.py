...
class CryptoNewsModule:
    ...
    def extract_crypto_trending(self, articles: List[Dict]) -> List[Dict]:
        ...
        try:
            ...
            trending = []
            for crypto, count in sorted(
                crypto_mentions, key=lambda x: x[1], reverse=True
            )[:10]:
                trending.append(
                    {
    ...
    def calculate_crypto_fear_greed(
        self, articles: List[Dict], sentiment: Dict
    ) -> Dict:
        ...
        try:
            ...
            fear_greed_score = (
                50
                + (sentiment_factor * 35)
                + (news_volume_factor * 10)
                + min(major_coin_bonus, 15)
            )
                                                    ...
                                                    children=[
                                                        html.Div(
                                                            [
                                                                ...
                                                                html.P(
                                                                    "Les protocoles décentralisés attirent plus d'attention",
                                                        ...
                                                        html.Div(
                                                            [
                                                                ...
                                                                html.P(
                                                                    "Les grandes entreprises s'intéressent aux cryptos",
                                                                    className="small text-muted",
                                                                ),
                                                            ],
                                                            className="mb-3",
                                                        ...
                                                        html.Div(
                                                            [
                                                                ...
                                                                html.P(
                                                                    "Les solutions de mise à l'échelle gagnent du terrain",
                                                                    className="small text-muted",
                                                                ),
                                                            ]
                                                        ),
    ...
    def setup_callbacks(self, app):
        ...
        @app.callback(
            Output("crypto-news-feed", "children"), [Input("crypto-news-store", "data")]
        )
            ...
            for article in news_data["news"][:20]:
                ...
                if impact == "high":
                    impact_badge = dbc.Badge(
                        "HIGH IMPACT", color="danger", className="me-2"
                    )
                elif impact == "medium":
                    impact_badge = dbc.Badge(
                        "MEDIUM", color="warning", className="me-2"
                    )
                else:
            ...
            try:
                ...
                if not news_data or not news_data.get("news"):
                    ...
                    if positive_score == 0 and negative_score == 0:
                        ...
                        positivity_ratio = (
                            positive_score / total_sentiment
                        ...
                        intensity = (
                            total_sentiment / total_articles
                            if total_articles > 0
                            else 0
                        )
        ...
        def update_crypto_trending_coins(news_data):
            ...
            try:
                ...
                for article in articles:
                    ...
                    for word, symbol in major_cryptos.items():
                        if word in text:
                            ...
                            positive_score = sum(
                                1 for pw in positive_words if pw in text
                            )
                            negative_score = sum(
                                1 for nw in negative_words if nw in text
                            )

                            if symbol not in crypto_sentiment:
                                crypto_sentiment[symbol] = {
                                    "positive": 0,
                                    "negative": 0,
                                }
                ...
                for symbol, mentions in crypto_mentions.most_common(6):
                    sentiment = crypto_sentiment.get(
                        symbol, {"positive": 0, "negative": 0}
                    )
                    ...
                    trending_items.append(
                        dbc.Row(
                            [
                                dbc.Col(
                                    html.Span(
                                        symbol, className=f"fw-bold {text_color}"
                                    ),
                                    width=4,
                                ),
                                dbc.Col(
                                    html.Span(
                                        f"{mentions} mentions", className="small"
                                    ),
                                    width=5,
                                    className="text-end",
                                ),
                        ...
                        dbc.Row(
                            [
                                ...
                                dbc.Col(
                                    [
                                        html.I(
                                            className="fas fa-sync-alt fa-spin text-info"
                                        )
                                    ],
                                    width=3,
                                    className="text-end",
            ...
            try:
                    ...
                    return html.Div(
                        [
                            ...
                            html.Div(
                                [
                                    html.H6(
                                        "📈 Adoption institutionnelle", className="mb-1"
                                    ),
                                    html.P(
                                        "Les grandes entreprises s'intéressent aux cryptos",
                                        className="small text-muted",
                ...
                for trend, score in sorted_trends[:4]:
                    if score > 0:
                        intensity = (
                            "forte"
                            if score >= 3
                            else "modérée" if score >= 2 else "faible"
                        )
                        color_class = (
                            "text-success"
                            if score >= 3
                            else "text-warning" if score >= 2 else "text-info"
                        )
                ...
                return html.Div(
                    [
                        ...
                        html.P(
                            "Impossible d'analyser les tendances actuellement",
                            className="small text-muted",
                        ),
                    ]
                )
